...
public class ObjectFactory {
    ...
    private final static QName _SayHello_QNAME = new QName("http://zl.com/", "sayHello");
    private final static QName _SayHello2Response_QNAME = new QName("http://zl.com/", "sayHello2Response");
    private final static QName _SayHello2_QNAME = new QName("http://zl.com/", "sayHello2");
    private final static QName _SayHelloResponse_QNAME = new QName("http://zl.com/", "sayHelloResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://zl.com/", name = "sayHello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://zl.com/", name = "sayHello2Response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://zl.com/", name = "sayHello2")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://zl.com/", name = "sayHelloResponse")

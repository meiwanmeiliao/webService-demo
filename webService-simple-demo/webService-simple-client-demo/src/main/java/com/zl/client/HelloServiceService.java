 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://zl.com/", wsdlLocation = "http://localhost:9001/service/sayHello1?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://zl.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9001/service/sayHello1?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://zl.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://zl.com/", "HelloServicePort"), HelloService.class, features);
    }

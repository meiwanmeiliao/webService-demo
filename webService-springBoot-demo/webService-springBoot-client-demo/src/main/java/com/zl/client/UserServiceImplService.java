 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://zl.com/", wsdlLocation = "http://127.0.0.1:8080/service/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://zl.com/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8080/service/user?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://zl.com/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://zl.com/", "UserServiceImplPort"), UserService.class, features);
    }
